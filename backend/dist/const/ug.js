...
const ug = {
    ...
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Mechanical Engineering': ['mech', 'mechanical'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Electrical Engineering': ['ele', 'electrical'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Civil Engineering': ['Civil', 'civ', 'civil'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Computer Science & Engineering': ['CSE', 'cs'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Electronics & Communication Engineering': ['ECE', 'Electronics'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Chemical Engineering': ['chem', 'Chemical'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Aerospace Engineering': ['Aerospace', 'aero'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Information Technology': ['IT', 'info', 'information'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Automobile Engineering': ['auto', 'Automobile'],
    'Bachelor of Engineering (BE)/Bachelor of Technology (BTech) Biomedical Engineering': ['Biomedical'],
