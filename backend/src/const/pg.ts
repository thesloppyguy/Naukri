const pg: { [key: string]: string[] } = {
  ...
  'Master of Business Administration Finance': ['finance', 'Finance'],
  'Master of Business Administration Marketing': ['marketing', 'Marketing'],
  ...
  'Master of Computer Applications Internet': ['internet', 'Internet'],
  ...
  'Master of Pharmacy Pharmaceutics': ['pharmaceutics', 'Pharmaceutics'],
  'Master of Pharmacy Pharmacology': ['pharmacology', 'Pharmacology'],
  ...
  'Master of Pharmacy Pharmacognosy': ['pharmacognosy', 'Pharmacognosy'],
  ...
  'Master of Education Special Education': ['special', 'Special'],
  ...
  'Master of Laws Corporate Law': ['corporate', 'Corporate'],
  'Master of Laws Criminal Law': ['criminal', 'Criminal'],
  'Master of Laws International Law': ['international', 'International'],
  ...
  'Master of Laws Tax Law': ['tax', 'Tax'],
  'Master of Laws Constitutional Law': ['constitutional', 'Constitutional'],
  'Master of Fine Arts': ['mfa', 'MFA', 'fine arts', 'Fine Arts'],
  'Master of Fine Arts Painting': ['painting', 'Painting'],
  'Master of Fine Arts Sculpting': ['sculpting', 'Sculpting'],
  'Master of Fine Arts Applied Arts': ['applied', 'Applied'],
  ...
  'Master of Fine Arts Printmaking': ['printmaking', 'Printmaking'],
  ...
  'Master of Public Health Epidemiology': ['epidemiology', 'Epidemiology'],
  'Master of Public Health Health Policy and Management': ['policy', 'Policy'],
  'Master of Public Health Biostatistics': ['biostatistics', 'Biostatistics'],
